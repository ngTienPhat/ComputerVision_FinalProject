...
public:
    ...
    */
    ...
    /*
    Detect edge with given method name (e.g. canny, sobel,...) 
        and its default arguments in ImageOperator class (see image_operator.hpp for more details)
    Input:
        method: string of these names: 
